...
X1_17DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=loader.get_robot_usd_path("X1", "X1_17dof.usd"),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "Joint_Ankle_Pitch_.*": -0.4,
            "Joint_Ankle_Roll_.*": 0.0,
            "Joint_Shoulder_Pitch_.*": 0.1,
            "Joint_Elbow_Pitch_.*": -0.4,
            "Joint_Waist_Yaw": 0.0,
        },
        joint_vel={".*": 0.0},
    ),
    ...
    actuators={
        ...
        "extras": ImplicitActuatorCfg(
            joint_names_expr=["Joint_Shoulder_Pitch_.*", "Joint_Waist_Yaw", "Joint_Elbow_Pitch_.*"],
            stiffness={
                "Joint_Shoulder_Pitch_.*": 20.0,
                "Joint_Elbow_Pitch_.*": 20.0,
                "Joint_Waist_Yaw": 150.0,
            },
            damping={
                "Joint_Shoulder_Pitch_.*": 2.0,
                "Joint_Elbow_Pitch_.*": 2.0,
                "Joint_Waist_Yaw": 5.0,
            },
            armature=0.01,
        ),

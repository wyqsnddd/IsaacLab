...
PUDU_D9_12DOF_UPDATED_ACTUATOR_CFG = ArticulationCfg(
    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            stiffness={
                ...
                ".*_Hip_Joint_Roll": 200.0,
                ".*_Hip_Joint_Yaw": 200.0,
                ".*_Knee_Joint_Pitch": 300.0,
            },
            damping={
                ".*_Hip_Joint_Pitch": 2.5,
                ".*_Hip_Joint_Roll": 2.5,
                ".*_Hip_Joint_Yaw": 2.5,
                ".*_Knee_Joint_Pitch": 4.0,
            },
            armature=0.0,
        ),
        "feet": ImplicitActuatorCfg(
            ...
            stiffness={
                ".*_Ankle_Joint_Pitch": 80.0,
                ".*_Ankle_Joint_Roll": 80.0,
            },
            damping={
                ".*_Ankle_Joint_Pitch": 2.5,
                ".*_Ankle_Joint_Roll": 2.5,
            },
            armature=0.00,
        ),
    },
